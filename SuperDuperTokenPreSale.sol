...
import "./SuperDuperToken.sol";

contract SuperDuperTokenPreSale {
    SuperDuperToken public token;
    ...
    function SuperDuperTokenPreSale(
        SuperDuperToken _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = SuperDuperToken(_token);
